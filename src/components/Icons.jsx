export const WifiIcon = () => (
  <svg width="14" height="10" viewBox="0 0 24 16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" style={{ marginLeft: 3 }}>
    <path d="M5 12.5C6.8 10.5 9.3 9.5 12 9.5s5.2 1 7 3" />
